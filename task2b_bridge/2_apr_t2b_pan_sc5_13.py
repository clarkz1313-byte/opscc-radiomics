"""
2_apr_t2b_pan_sc5_13.py  --  Task 2B v13 strict cohort rerun

Broader strict rerun forked from v7.

Search space:
- same curated v7 union feature space (11 PT + 7 CT)
- same structures: 4-5 PT x 2-3 CT
...
This script is intended as the first leak-aware broad rerun because the strict
finalist recheck suggested the 4-5 PT v7-style space is still the most relevant
starting point under the old Task 2 split.

Run:
    python Apr_2026_task2B/2_apr_t2b_pan_sc5_13.py
"""
...
SCREEN_CSV = OUT_DIR / "t2b_screen_13.csv"
CHECKPOINTS_CSV = OUT_DIR / "t2b_checkpoints_13.csv"
ALL_CSV = OUT_DIR / "t2b_all_results_13.csv"
TOP20_STRICT_CSV = OUT_DIR / "t2b_top20_strict_13.csv"
TOP20_EXT_CSV = OUT_DIR / "t2b_top20_ext_13.csv"
LOG_MD = OUT_DIR / "t2b_log_13.md"
...
def run(args: argparse.Namespace) -> None:
    ...
    if passed_soft.empty:
        ...
        LOG_MD.write_text("# Task 2B v13 Log\n\nNo Stage-1 soft-floor survivors.\n", encoding="utf-8")
        return
...
def main() -> None:
    ...
    print(
        f"ROOT={ROOT}\n"
        f"v13 strict rerun from v7 union sweep | PT sizes={PT_SIZES} | CT sizes={CT_SIZES} | "
