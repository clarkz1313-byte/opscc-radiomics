# -*- coding: utf-8 -*-
"""
Task 2 Stage 2: PT two-step feature-selection pipelines.
...
Usage:
    cd "D:/Uppsala thesis"
    python Mar_2026_task2/13_mar_task2_stage2_PT.py
"""
...
OUT_CSV = RESULTS_DIR / "13_mar_task2_stage2_PT_result.csv"
OUT_PKL = RESULTS_DIR / "13_mar_task2_stage2_PT_features.pkl"
OUT_META = RESULTS_DIR / "13_mar_task2_stage2_PT_metadata.json"
CHECKPOINT = RESULTS_DIR / "13_mar_task2_stage2_PT_checkpoint.pkl"
...
S1_CANDIDATES = [
    {"rank": "PT_14", "cat": "A", "label": "A7: ANOVA (top 100)", "selector_key": "A7", "selector_param": 100},
    {"rank": "PT_17", "cat": "A", "label": "A0: MWU AUC (p<0.05 uncorr)", "selector_key": "A0", "selector_param": "uncorr"},
    {"rank": "PT_18", "cat": "A", "label": "A7: ANOVA (top 200)", "selector_key": "A7", "selector_param": 200},
    {"rank": "PT_8", "cat": "B", "label": "B1: Corr filter (r<0.85)", "selector_key": "B1", "selector_param": 0.85},
    {"rank": "PT_11", "cat": "B", "label": "B3: mRMR classif (top 30)", "selector_key": "B3", "selector_param": 30},
    {"rank": "PT_23", "cat": "B", "label": "B3: mRMR classif (top 50)", "selector_key": "B3", "selector_param": 50},
    {"rank": "PT_1", "cat": "C", "label": "C1: LASSO-Logistic (target 30)", "selector_key": "C1", "selector_param": 30},
    {"rank": "PT_2", "cat": "C", "label": "C2: ElasticNet-Logistic (target 60)", "selector_key": "C2", "selector_param": 60},
    {"rank": "PT_3", "cat": "C", "label": "C2: ElasticNet-Logistic (target 30)", "selector_key": "C2", "selector_param": 30},
]
...
results_df.insert(0, "Rank", [f"PT_S2_{i}" for i in range(1, len(results_df) + 1)])
