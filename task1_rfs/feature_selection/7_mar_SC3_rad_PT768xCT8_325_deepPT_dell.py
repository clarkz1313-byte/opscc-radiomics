"""
7_mar_SC3_rad_PT768xCT8_325_deepPT_dell.py
...
Outputs: Mar_2026/7_mar_SC3_rad_PT768xCT8_325_deepPT_dell_outputs/

Usage:
  python Mar_2026/7_mar_SC3_rad_PT768xCT8_325_deepPT_dell.py
  SC3_TRIALS=700 python Mar_2026/7_mar_SC3_rad_PT768xCT8_325_deepPT_dell.py
"""
...
OUTPUT_DIR = ROOT / "7_mar_SC3_rad_PT768xCT8_325_deepPT_dell_outputs"
...
# LOGGING
# ==========================================
LOG_FILE_PATH = OUTPUT_DIR / "7_mar_SC3_rad_PT768xCT8_325_deepPT_dell_log.md"
...
# ==========================================
print("=" * 70)
print("7_mar_SC3_rad_PT768xCT8_325_deepPT_dell")
...
for method in RANKING_METHODS:
    ...
    for gm_name in GM_MODEL_NAMES:
        ...
        # Strategy: force TPE into high-n_pt region it never samples with N_MAX<=15
        if method == "GBS":
            if gm_name in ("SVM", "CoxPH"):
                ...
                study.enqueue_trial({"total_n": 18, "clin_ratio": 0.06, "n_pt": 16, "n_e": 100, "lr": 0.1, "m_d": 3, "ss": 0.8})
                study.enqueue_trial({"total_n": 12, "clin_ratio": 0.08, "n_pt": 10, "n_e": 100, "lr": 0.1, "m_d": 3, "ss": 0.8})
            elif gm_name == "EST":
                study.enqueue_trial({"total_n": 18, "clin_ratio": 0.06, "n_pt": 16, "n_e": 300, "m_d": 12, "m_s_s": 6, "m_s_l": 4, "m_f": "sqrt"})
                study.enqueue_trial({"total_n": 12, "clin_ratio": 0.08, "n_pt": 10, "n_e": 300, "m_d": 12, "m_s_s": 6, "m_s_l": 4, "m_f": "sqrt"})
        elif method == "UNIVAR":
            if gm_name in ("SVM", "CoxPH"):
                alpha_key = "alpha_svm" if gm_name == "SVM" else "alpha_cox"
                alpha_val = 0.01 if gm_name == "SVM" else 0.1
                ...
                study.enqueue_trial({"total_n": 20, "clin_ratio": 0.05, "n_pt": 18, "n_e": 100, "lr": 0.1, "m_d": 3, "ss": 0.8})
                study.enqueue_trial({"total_n": 15, "clin_ratio": 0.07, "n_pt": 13, "n_e": 100, "lr": 0.1, "m_d": 3, "ss": 0.8})
            elif gm_name == "EST":
                study.enqueue_trial({"total_n": 20, "clin_ratio": 0.05, "n_pt": 18, "n_e": 300, "m_d": 12, "m_s_s": 6, "m_s_l": 4, "m_f": "sqrt"})
        elif method == "StabLASSO":
            # StabLASSO needs n_pt>=30 to cover 8/9 PT817 feats -- push near N_MAX
            if gm_name in ("SVM", "CoxPH"):
                alpha_key = "alpha_svm" if gm_name == "SVM" else "alpha_cox"
                alpha_val = 0.01 if gm_name == "SVM" else 0.1
                study.enqueue_trial({"total_n": 20, "clin_ratio": 0.05, "n_pt": 18, alpha_key: alpha_val})
...
out_path = OUTPUT_DIR / "7_mar_SC3_rad_PT768xCT8_325_deepPT_dell_all_results.csv"
...
top10_path = OUTPUT_DIR / "7_mar_SC3_rad_PT768xCT8_325_deepPT_dell_top10.csv"
top10.to_csv(top10_path, index=False)
print(f"\nSaved top10: {top10_path.name}")

print("\n7_mar_SC3_rad_PT768xCT8_325_deepPT_dell finished.")
