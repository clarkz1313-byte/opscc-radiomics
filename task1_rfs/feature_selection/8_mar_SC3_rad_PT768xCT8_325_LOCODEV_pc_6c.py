"""
8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6c.py

Exhaustive SC3 separate-prefilter run.
pc_6c: PT/CT separate UNIVAR prefilter (PT20 + CT10), then evt/EPV-cut ranking.
...
Outputs: Mar_2026/8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6c_outputs/

Usage:
  python Mar_2026/8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6c.py
  SC3_TRIALS=1000 python Mar_2026/8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6c.py
"""
...
OUTPUT_DIR = ROOT / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6c_outputs"
...
# LOGGING
# ==========================================
LOG_FILE_PATH = OUTPUT_DIR / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6c_log.md"
...
# ==========================================
print("=" * 70)
print("8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6c")
print("Exhaustive: pc_6c separate prefilter (PT20+CT10) | N_BOOT=0")
...
# ==========================================
# 2. PRE-COMPUTE RANKINGS — separate prefilter rankers
# ==========================================
print("\n--- Pre-computing feature rankings (PT20+CT10 prefilter; evt/EPV-cut) ---")
g_sc = StandardScaler()
...
out_path = OUTPUT_DIR / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6c_all_results.csv"
...
print("\n8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6c finished.")
