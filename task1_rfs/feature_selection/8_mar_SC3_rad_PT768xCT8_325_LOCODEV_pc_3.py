"""
8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_3.py

Exhaustive SC3 with 4 LOCO-only rankers. No bootstrap. N_MAX=12, CT_MIN=1.
...
Outputs: Mar_2026/8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_3_outputs/

Usage:
  python Mar_2026/8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_3.py
  SC3_TRIALS=1000 python Mar_2026/8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_3.py
"""
...
OUTPUT_DIR = ROOT / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_3_outputs"
...
# LOGGING
# ==========================================
LOG_FILE_PATH = OUTPUT_DIR / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_3_log.md"
...
# ==========================================
print("=" * 70)
print("8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_3")
print("Exhaustive: ALL Optuna trials x 4 coaches | 4 LOCO rankers only; N_BOOT=0")
...
ranked_rad_univar = univar_rank(X_train_sc[:, rad_idx_list], y_train, rad_feat)[0]
...
for method in RANKING_METHODS:
    ...
    for gm_name in GM_MODEL_NAMES:
        ...
        # Checkpoint export: write CSV after each ranker/GM
        checkpoint_df = pd.DataFrame(all_rows)
        checkpoint_path = OUTPUT_DIR / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_3_checkpoint.csv"
        checkpoint_df.to_csv(checkpoint_path, index=False)
        print(f"    Checkpoint saved: {len(checkpoint_df)} rows")

# ==========================================
# 4. BOOTSTRAP TOP CANDIDATES + SAVE (skipped when N_BOOT=0)
# ==========================================
...
out_path = OUTPUT_DIR / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_3_all_results.csv"
...
# Top20 CSV export: write top20 CSV and print Saved top20 message
top20_path = OUTPUT_DIR / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_3_top20.csv"
top20_out.to_csv(top20_path, index=False)
print(f"\nSaved top20: {top20_path.name}")

print("\n8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_3 finished.")
