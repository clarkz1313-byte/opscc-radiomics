"""
8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_4.py

Exhaustive SC3 with UNIVAR30 + 5 LOCO variants redesign.
...
Outputs: Mar_2026/8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_4_outputs/

Usage:
  python Mar_2026/8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_4.py
  SC3_TRIALS=1000 python Mar_2026/8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_4.py
"""
...
OUTPUT_DIR = ROOT / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_4_outputs"
...
# LOGGING
# ==========================================
LOG_FILE_PATH = OUTPUT_DIR / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_4_log.md"
...
def enqueue_structural_seeds(study, alpha_key):
    ...
    structures = [
        {"total_n": 6, "n_clin": 1, "n_pt": 4},
        {"total_n": 7, "n_clin": 1, "n_pt": 5},
        {"total_n": 8, "n_clin": 1, "n_pt": 5},
        {"total_n": 8, "n_clin": 2, "n_pt": 5},
        {"total_n": 9, "n_clin": 1, "n_pt": 6},
        {"total_n": 10, "n_clin": 2, "n_pt": 6},
    ]
    for s in structures:
...
# ==========================================
print("=" * 70)
print("8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_4")
print("Exhaustive: UNIVAR30 + 5 LOCO variants (evt/weighted/cut) | N_BOOT=0")
...
print("  UNIVAR30_WLOCO_epv_ratio PT ranking (PT817 marked with *):")
for ri, f in enumerate(rankings["UNIVAR30_WLOCO_epv_ratio"]["pt"], 1):
...
print("  UNIVAR30_WLOCO_epv_ratio CT ranking (PT817-CT marked with *):")
for ri, f in enumerate(rankings["UNIVAR30_WLOCO_epv_ratio"]["ct"], 1):
    marker = " *PT817-CT*" if f in CT817_FEATURES else ""
    print(f"    {ri:2d}. {f}{marker}")
print("  5-ranker setup done")
...
out_path = OUTPUT_DIR / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_4_all_results.csv"
...
print("\n8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_4 finished.")
