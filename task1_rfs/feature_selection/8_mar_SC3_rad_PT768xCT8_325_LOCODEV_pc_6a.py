"""
8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6a.py

Exhaustive SC3 replication-first run.
pc_6a: FULL_LOCO_evt only, widened PT range to recover pc_3 near-best lane.
...
Outputs: Mar_2026/8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6a_outputs/

Usage:
  python Mar_2026/8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6a.py
  SC3_TRIALS=1000 python Mar_2026/8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6a.py
"""
...
OUTPUT_DIR = ROOT / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6a_outputs"
...
# LOGGING
# ==========================================
LOG_FILE_PATH = OUTPUT_DIR / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6a_log.md"
...
def enqueue_structural_seeds(study, alpha_key):
    ...
    structures = [
        {"total_n": 10, "n_clin": 1, "n_pt": 8},  # pc_3 near-best lane
...
# ==========================================
print("=" * 70)
print("8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6a")
print("Exhaustive: pc_6a replication-first (FULL_LOCO_evt only) | N_BOOT=0")
...
out_path = OUTPUT_DIR / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6a_all_results.csv"
...
print("\n8_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_6a finished.")
