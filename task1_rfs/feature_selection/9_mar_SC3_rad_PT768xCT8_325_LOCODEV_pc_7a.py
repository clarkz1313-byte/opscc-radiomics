"""
9_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_7a.py

Exhaustive SC3 replication-first run.
pc_7a: replication control - FULL_LOCO_evt, pc_3 bounds, explicit pocket seeds.
...
Expected rows: TRIALS * 1 * 2 * 4 (e.g. 2000*8 = 16k)

Outputs: Mar_2026/9_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_7a_outputs/

Usage:
  python Mar_2026/9_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_7a.py
  SC3_TRIALS=1000 python Mar_2026/9_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_7a.py
"""
...
OUTPUT_DIR = ROOT / "9_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_7a_outputs"
...
# LOGGING
# ==========================================
LOG_FILE_PATH = OUTPUT_DIR / "9_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_7a_log.md"
...
# ==========================================
print("=" * 70)
print("9_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_7a")
print("Exhaustive: pc_7a replication-first (FULL_LOCO_evt only) | N_BOOT=0")
...
# ==========================================
print("\n--- Pre-computing feature rankings (FULL_LOCO_evt only) ---")
g_sc = StandardScaler()
...
out_path = OUTPUT_DIR / "9_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_7a_all_results.csv"
...
print("\n9_mar_SC3_rad_PT768xCT8_325_LOCODEV_pc_7a finished.")
