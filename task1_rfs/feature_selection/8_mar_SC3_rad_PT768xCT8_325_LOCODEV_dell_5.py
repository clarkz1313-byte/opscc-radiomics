"""
8_mar_SC3_rad_PT768xCT8_325_LOCODEV_dell_5.py

Traditional SC3 with 6 LOCO rankers (3 full-pool + 3 UNIVAR30-prefiltered). No bootstrap.
...
Outputs: Mar_2026/8_mar_SC3_rad_PT768xCT8_325_LOCODEV_dell_5_outputs/

Usage:
  python Mar_2026/8_mar_SC3_rad_PT768xCT8_325_LOCODEV_dell_5.py
"""
...
OUTPUT_DIR = ROOT / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_dell_5_outputs"
...
# LOGGING
# ==========================================
LOG_FILE_PATH = OUTPUT_DIR / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_dell_5_log.md"
...
# ==========================================
print("=" * 70)
print("8_mar_SC3_rad_PT768xCT8_325_LOCODEV_dell_5")
print("Traditional SC3: 6 LOCO rankers (3 full + 3 UNIVAR30); N_BOOT=0")
print("Rankers: FULL_LOCO_evt / FULL_WLOCO_epv_cut / FULL_LOCO_EPV_CUT / UNIVAR30_LOCO_evt / UNIVAR30_WLOCO_epv_cut / UNIVAR30_LOCO_EPV_CUT")
...
# ==========================================
# 2. PRE-COMPUTE RANKINGS — 6 LOCO rankers (full + UNIVAR30)
# ==========================================
print("\n--- Pre-computing feature rankings (6 LOCO rankers; full and UNIVAR30 pools) ---")
g_sc = StandardScaler()
...
ranker_mode_map = {
    ...
    "UNIVAR30_LOCO_evt": ("loco_evt", "u30"),
    "UNIVAR30_WLOCO_epv_cut": ("w_epv_cut", "u30"),
    "UNIVAR30_LOCO_EPV_CUT": ("loco_epv_cut", "u30"),
}
...
out_path = OUTPUT_DIR / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_dell_5_all_results.csv"
...
top10_path = OUTPUT_DIR / "8_mar_SC3_rad_PT768xCT8_325_LOCODEV_dell_5_top10.csv"
top10.to_csv(top10_path, index=False)
print(f"\nSaved top10: {top10_path.name}")

print("\n8_mar_SC3_rad_PT768xCT8_325_LOCODEV_dell_5 finished.")
